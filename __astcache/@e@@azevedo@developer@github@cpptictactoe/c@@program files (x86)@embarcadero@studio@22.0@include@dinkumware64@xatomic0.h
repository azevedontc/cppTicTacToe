...
typedef _Uint4_t _Atomic_integral_t;
  ...
  #define _LONGLONG_SIZE	8
   ...
   #else /* __GNUC__ || _CLANG */
    #define _LONG_SIZE		4
   #endif /* __GNUC__ || _CLANG */
...
_CRTIMP2P _Uint4_t _PCDECL _Atomic_load_4_locking(volatile _Atomic_flag_t *,
	_Uint4_t *, memory_order);
_CRTIMP2P int _PCDECL _Atomic_compare_exchange_weak_4_locking(
	volatile _Atomic_flag_t *, _Uint4_t *, _Uint4_t *, _Uint4_t,
		memory_order, memory_order);
_CRTIMP2P _Uint4_t _PCDECL _Atomic_fetch_add_4_locking(volatile _Atomic_flag_t *,
	_Uint4_t *, _Uint4_t, memory_order);
_CRTIMP2P _Uint4_t _PCDECL _Atomic_fetch_sub_4_locking(volatile _Atomic_flag_t *,
	_Uint4_t *, _Uint4_t, memory_order);
...
#define _Compare_increment_atomic_counter(_Counter, _Expected)	\
	_Compare_increment_atomic_counter_explicit( \
		...
		/* SPIN LOCKS */
_EXTERN_C
_CRTIMP2P void _Lock_shared_ptr_spin_lock();
_CRTIMP2P void _Unlock_shared_ptr_spin_lock();
_END_EXTERN_C
_STD_END
#endif /* _XATOMIC0_H */
